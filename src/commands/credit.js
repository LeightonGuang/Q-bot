const { SlashCommandBuilder, EmbedBuilder, ActionRowBuilder, StringSelectMenuBuilder, Embed } = require('discord.js');
...
module.exports = {
  ...
  async execute(interaction) {
    let creditEmbed = new EmbedBuilder()
      ...
      .addFields(
        { name: "<:Pog:1139840279659159582>", value: "<@691784137790717984>" }
      )
      .setTimestamp()
